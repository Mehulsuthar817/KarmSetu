...
function NavItem({ item, onClose }) {
  ...
  return (
    ...
    >
      ...
      <Link to={item.to} onClick={onClose} style={{ textDecoration: "none" }}>
        <motion.div
          animate={{
...
function PrismTrigger({ onClick }) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        animate={{
          boxShadow: `0 0 24px 8px ${color}66, 0 0 48px 16px ${color}33`,
        }}
        style={{
          width: "48px",
          height: "48px",
...
export default function PrismNavbar() {
  ...
  return !item.role || item.role === user?.role;
});
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <motion.div
              animate={{
                background: `linear-gradient(90deg, transparent, ${prismColor}88, transparent)`,
              }}
              style={{
                height: "1px",
                marginBottom: "20px",
            ...
            <motion.div
              animate={{
                background: `radial-gradient(ellipse at 50% 100%, ${prismColor}22, transparent 70%)`,
              }}
              style={{
                position: "absolute",
                bottom: 0,
